...
const roboImage = document.querySelector('#roboImg');
...
function updateBatteryStatus(battery) {
    ...
    const roboUrl = `https://robohash.org/${batteryPercentage}.png`;
    
    roboImage.setAttribute("src", roboUrl);
    roboImage.setAttribute("alt", "Robo Image");
